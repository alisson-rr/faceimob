...
import { Calendar as CalendarIcon, Trophy, Filter, RefreshCw } from "lucide-react";
...
// Manager teams - two colored tables
const managerTeams = [
  {
    managers: [
...
const brokerRanking = [
  ...
  { pos: 11, name: "Roqueane Bastos Araujo", leads: 5, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 12, name: "Saph Nova", leads: 27, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 13, name: "Gustavo Tavares", leads: 7, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 14, name: "Alberto Lu", leads: 42, vendas: 0, agd: 0, neg: 0, qtdVendas: 2, vgv: "R$412.000,00", cm: 0 },
  { pos: 15, name: "Cledina dos Santos Silva", leads: 6, vendas: 1, agd: 0, neg: 0, qtdVendas: 1.5, vgv: "R$625.506,45", cm: 1 },
  { pos: 16, name: "Vanessa Oliveira", leads: 15, vendas: 1, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 17, name: "Carolina Cacerini", leads: 9, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$420.000,00", cm: 0 },
  { pos: 18, name: "Paulo Branco", leads: 15, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 19, name: "Paulo Santos", leads: 1, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$130.000,00", cm: 0 },
  { pos: 20, name: "Anna Maldonato", leads: 63, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 21, name: "Alexandre Chaves", leads: 0, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$506.480,00", cm: 0 },
  { pos: 22, name: "Marcone Vilas Boas", leads: 22, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 23, name: "Everio Silva", leads: 3, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 24, name: "Danie Cris", leads: 0, vendas: 149, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 25, name: "Isabel Santos", leads: 4, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$0,00", cm: 0 },
  { pos: 26, name: "Anna Gordes", leads: 0, vendas: 0, agd: 0, neg: 0, qtdVendas: 0, vgv: "R$1.061.000,00", cm: 0 },
];
...
// Helper: cell color based on value
    ...
    <div className="space-y-4 text-sm">
      ...
      <div className="flex flex-wrap items-stretch gap-1">
        {topMetrics.map((m) => (
          <div
            key={m.label}
            className="flex flex-col items-center justify-center px-3 py-2 rounded border border-border/50 bg-card/80 min-w-[100px]"
          >
            <span className="text-[10px] text-muted-foreground uppercase tracking-wider whitespace-nowrap">{m.label}</span>
            <span className={cn(
              "text-lg font-bold",
              m.label === "VGV" ? "text-emerald-400 text-sm" : "text-foreground"
            )}>{m.value}</span>
          </div>
        ))}
        {/* Meta atingida */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
        {/* Vendas */}
        <Card className="border-emerald-600/50 bg-card/70">
          <CardHeader className="py-2 px-3">
            <CardTitle className="text-xs font-semibold text-emerald-400">Vendas</CardTitle>
          </CardHeader>
          <CardContent className="p-0">
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border/30 text-muted-foreground">
                  <th className="text-left p-2 font-medium">Construtora</th>
                  <th className="text-right p-2 font-medium">Unidades</th>
                  <th className="text-right p-2 font-medium">VGV</th>
                </tr>
              </thead>
              <tbody>
                {vendasConstrutora.map((row) => (
                  <tr key={row.construtora} className="border-b border-border/10 hover:bg-secondary/30">
                    <td className="p-2">{row.construtora}</td>
        ...
        {/* Propostas */}
        <Card className="border-blue-600/50 bg-card/70">
          <CardHeader className="py-2 px-3">
            <CardTitle className="text-xs font-semibold text-blue-400">Propostas</CardTitle>
          </CardHeader>
          <CardContent className="p-0">
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border/30 text-muted-foreground">
                  <th className="text-left p-2 font-medium">Const.</th>
                  <th className="text-right p-2 font-medium">Prop.</th>
                  <th className="text-right p-2 font-medium">Neg.</th>
                  <th className="text-right p-2 font-medium">VGV</th>
                </tr>
              </thead>
              <tbody>
                {propostasConstrutora.map((row) => (
                  <tr key={row.construtora} className="border-b border-border/10 hover:bg-secondary/30">
                    <td className="p-2">{row.construtora}</td>
        ...
        {/* Metas */}
        <Card className="border-amber-600/50 bg-card/70">
          <CardHeader className="py-2 px-3">
            <CardTitle className="text-xs font-semibold text-amber-400">Metas</CardTitle>
          </CardHeader>
          <CardContent className="p-0">
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border/30 text-muted-foreground">
                  ...
                  <th className="text-right p-2 font-medium">Obtido</th>
                </tr>
              </thead>
              <tbody>
                {metasConstrutora.map((row) => (
                  <tr key={row.construtora} className="border-b border-border/10 hover:bg-secondary/30">
                    <td className="p-2">{row.construtora}</td>
                    ...
                    <td className="p-2">
                      <span className={cn(
                        ...
                        row.pct >= 80 ? "bg-emerald-600 text-white" : row.pct >= 50 ? "bg-yellow-600 text-white" : "bg-red-600 text-white"
                      )}>
                        {row.pct}%
                      </span>
                    </td>
      ...
      {/* ── MANAGER TEAM TABLES (colored rows) ─────────────── */}
      {managerTeams.map((team, ti) => (
        <Card key={ti} className={cn("bg-card/70", team.borderColor)}>
          <CardContent className="p-0 overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-border/30 text-muted-foreground">
                  <th className="p-2 text-right font-medium">Meta</th>
                  <th className="p-2 text-right font-medium">Mede</th>
                  <th className="p-2 font-medium">% Imóble</th>
                  <th className="p-2 font-medium">Gerente</th>
                  <th className="p-2 text-right font-medium">Leads</th>
                  <th className="p-2 text-right font-medium">Agd</th>
                  <th className="p-2 text-right font-medium">Neg.</th>
                  <th className="p-2 text-right font-medium">Vendas</th>
                  <th className="p-2 text-right font-medium">VGV</th>
                  <th className="p-2 text-right font-medium">CM</th>
                </tr>
              </thead>
              <tbody>
                {team.managers.map((m, mi) => (
                  <tr key={mi} className="border-b border-border/10">
                    <td className="p-2 text-right">{m.rank}</td>
                    <td className="p-2 text-right">{m.meta}</td>
                    <td className="p-2">
                      <span className={cn("px-2 py-0.5 rounded text-[10px] font-bold text-white", m.pctColor)}>{m.pct}</span>
                    </td>
                    <td className="p-2 font-medium">{m.construtora}</td>
                    <td className={cn("p-2 text-right font-semibold", m.leads > 1000 ? "text-emerald-400" : "text-amber-400")}>{m.leads}</td>
                    <td className="p-2 text-right text-red-400">{m.agd}</td>
                    <td className="p-2 text-right text-red-400">{m.neg}</td>
                    <td className="p-2 text-right font-semibold text-emerald-400">{m.vendas}</td>
                    <td className="p-2 text-right text-emerald-300 text-[11px]">{m.vgv}</td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <Card className="bg-card/70 border-border/50">
          <CardHeader className="py-2 px-3">
            <CardTitle className="text-xs font-semibold">Origem dos Leads</CardTitle>
          </CardHeader>
          <CardContent className="p-3">
            <table className="w-full text-xs">
              <tbody>
                {leadOrigins.map((o) => (
                  <tr key={o.source} className="border-b border-border/10">
                    <td className="py-1.5">{o.source}</td>
                    <td className="py-1.5 text-right font-semibold">{o.count}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <Card className="bg-card/70 border-border/50">
          <CardHeader className="py-2 px-3">
            <CardTitle className="text-xs font-semibold">Status CCA</CardTitle>
          </CardHeader>
          <CardContent className="p-3">
            <table className="w-full text-xs">
              <tbody>
                {ccaStatusList.map((s) => (
                  <tr key={s.label} className="border-b border-border/10">
                    <td className={cn("py-1.5", s.color)}>{s.label}</td>
        ...
        <div className="flex gap-2">
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" size="sm" className="text-xs">
                ...
                {dateRange.from ? format(dateRange.from, "dd/MM/yyyy") : "07/12/2025"}
              </Button>
            </PopoverTrigger>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" size="sm" className="text-xs">
                <CalendarIcon className="h-3 w-3 mr-1" />
                {dateRange.to ? format(dateRange.to, "dd/MM/yyyy") : "07/12/2026"}
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-auto p-0" align="center">
      ...
      {/* ── STAFF ──────────────────────────────────────────── */}
      <Card className="bg-card/70 border-border/50 max-w-md mx-auto">
        <CardHeader className="py-2 px-3">
          <CardTitle className="text-xs font-semibold text-emerald-400 text-center">Staff</CardTitle>
        </CardHeader>
        <CardContent className="p-3">
          <table className="w-full text-xs">
            <tbody>
              {staffData.map((s) => (
                <tr key={s.label} className={cn("border-b border-border/10", s.bold && "font-bold")}>
                  <td className={cn("py-1", s.highlight && "text-amber-400")}>{s.label}</td>
                  <td className="py-1 text-right font-semibold">{s.value}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {/* ── RANKING GERAL ──────────────────────────────────── */}
      <Card className="border-cyan-700/50 bg-card/70">
        <CardHeader className="py-2 px-3 flex flex-row items-center justify-between">
          <CardTitle className="text-xs font-semibold flex items-center gap-2">
            <Trophy className="h-4 w-4 text-cyan-400" />
            <span className="text-cyan-400">Ranking Geral</span>
          </CardTitle>
                ...
                return (
                  <tr key={row.pos} className="border-b border-border/10 hover:bg-secondary/20">
                    <td className="p-2 text-center">
                      {row.pos <= 3 ? <span className="text-sm">{medals[row.pos - 1]}</span> : <span className="text-muted-foreground">{row.pos}</span>}
                    </td>
                    <td className="p-2 font-medium whitespace-nowrap">{row.name}</td>
                    <td className="p-2 text-right">
                      <span className={cn("px-1.5 py-0.5 rounded text-[10px] font-bold", row.leads > 20 ? "bg-emerald-600/60 text-white" : row.leads > 0 ? "bg-yellow-600/60 text-white" : "bg-red-600/40 text-red-300")}>{row.leads}</span>
                    </td>
                    <td className="p-2 text-right">
                      <span className={cn("px-1.5 py-0.5 rounded text-[10px] font-bold", row.vendas > 0 ? "bg-emerald-600/60 text-white" : "bg-red-600/40 text-red-300")}>{row.vendas}</span>
                    </td>
                    <td className="p-2 text-right">
                      <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-red-600/40 text-red-300">{row.agd}</span>
                    </td>
                    <td className="p-2 text-right">
                      <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-red-600/40 text-red-300">{row.neg}</span>
                    </td>
                    <td className="p-2 text-right">
                      <span className={cn("px-1.5 py-0.5 rounded text-[10px] font-bold", row.qtdVendas > 0 ? "bg-emerald-600/60 text-white" : "bg-red-600/40 text-red-300")}>{row.qtdVendas}</span>
                    </td>
                    <td className="p-2 text-right">
                      <span className={cn("text-[10px] font-semibold", row.vgv !== "R$0,00" ? "text-emerald-400" : "text-red-400")}>{row.vgv}</span>
                    </td>
                    <td className="p-2 text-right">
                      <span className={cn("px-1.5 py-0.5 rounded text-[10px] font-bold", row.cm > 0 ? "bg-emerald-600/60 text-white" : "bg-red-600/40 text-red-300")}>{row.cm}</span>
                    </td>
                  </tr>
                );
              })}
