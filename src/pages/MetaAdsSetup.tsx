  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <PageHeader
        ...
        icon={Facebook}
        description="Receba os leads do Lead Ads em tempo real e conecte a Marketing API para ler gasto e resultados das campanhas."
        actions={badge}
      />
      ...
      {/* Escrito na tela porque a ausência silenciosa vira expectativa. É o
          token da Marketing API que decide qual das duas frases vale: com ele
          e as contas ligadas, o sistema lê a Meta e executa pausar/ativar/verba;
          sem ele, Marketing continua registro local. */}
      <SectionCard title="Até onde esta integração vai" icon={AlertTriangle}>
        <div className="space-y-2 text-sm text-muted-foreground">
          <p>
            Aqui se configura o <b>recebimento</b> de leads do Lead Ads e a <b>conexão com a Marketing API</b>. Com o
            token no cofre e as contas ligadas acima, o sistema lê da Meta, uma vez por dia, o gasto, a verba, o status
            e os resultados de cada campanha, e quem tem a permissão &quot;Gerenciar campanhas na Meta&quot; pausa,
            ativa e muda verba em{" "}
            <Link to="/marketing" className="font-medium text-primary hover:underline">Marketing → Campanhas</Link>,
            sempre com confirmação e registro de quem fez.
          </p>
          <p>
            Sem o token, nada disso liga: a gestão em Marketing continua sendo <b>registro local</b>, com gasto
            digitado ou importado da planilha, e nada é enviado para a Meta. Criar, duplicar ou editar anúncio continua
            no Gerenciador de Anúncios. Pausar e mudar verba pela API exigem token com escopo <code>ads_management</code>{" "}
            e o app aprovado pela Meta; anúncio de imóvel é categoria especial, com segmentação restrita.
          </p>
        </div>
      </SectionCard>
