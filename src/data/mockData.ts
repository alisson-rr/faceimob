...
export const mockDeals: PipelineDeal[] = [
  { id: '1', client: 'João Pereira', developer: 'Cyrela', project: 'Residencial Aurora', unit: '12A', status: 'Ativo', stage: 'proposal', broker1: 'Carlos Silva', broker2: 'Ana Martins', manager1: 'Marcos Oliveira', deal_value: 650000, days_in_pipeline: 12, active: true, created_at: '2026-02-21' },
  { id: '2', client: 'Maria Santos', developer: 'MRV', project: 'Parque das Flores', unit: '305', status: 'Ativo', stage: 'visit_scheduled', visit_date: '2026-03-10', broker1: 'Ana Martins', manager1: 'Marcos Oliveira', deal_value: 420000, days_in_pipeline: 8, active: true, created_at: '2026-02-25' },
  ...
  { id: '4', client: 'Ricardo Mendes', developer: 'Eztec', project: 'Sky Tower', unit: '1801', status: 'Ativo', stage: 'contract', broker1: 'Fernando Lima', broker2: 'Carlos Silva', manager1: 'Ricardo Santos', deal_value: 1200000, days_in_pipeline: 45, active: true, created_at: '2026-01-19' },
