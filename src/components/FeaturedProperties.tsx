...
const PropertyCard3D = ({ property }: { property: typeof properties[0] }) => {
  ...
  return (
    <motion.div
      ...
      className="group bg-card rounded-xl overflow-hidden shadow-card hover:shadow-elevated transition-shadow duration-300 cursor-pointer will-change-transform"
    >
      {/* Image */}
      ...
      {/* Content */}
      <div className="p-3 md:p-4" style={{ transform: "translateZ(20px)" }}>
